        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative modal" no-repeat center center;">
                <div class="card">
                    <div class="card-header bg-success">
                        <h3 class="text-center text-white text-truncate font-weight-medium">Login Pengawas</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="<?php echo site_url('admin/login/aksi_login'); ?>" method="POST">
                            <!-- <div class="row">
                                ...
                                <div class="col-lg-12 text-center"> -->
                                    <button type="submit" value="login" class="btn btn-success w-100">Login</button>
                                <!-- </div>
                            </div> -->
                        </form>
                    </div>
                    <div><span><?php $this->load->view("admin/__partials/footer.php") ?></span></div>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
