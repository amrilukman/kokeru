                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <form action="" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo $cs->idcs ?>" />

                            <div class="form-group">
                                <input class="form-control <?php echo form_error('idcs') ? 'is-invalid':'' ?>"
                                type="text" name="idcs" placeholder="ID" value="<?php echo $cs->idcs ?>" />
                            ...
                            <div class="form-group">
                                ...
                                type="text" name="nama" placeholder="Nama" value="<?php echo $cs->nama ?>" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                type="email" name="email" placeholder="Email" value="<?php echo $cs->email ?>" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                type="password" name="password" placeholder="Password" value="<?php echo $cs->password ?>" />
                                <div class="invalid-feedback">
