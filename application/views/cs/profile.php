...
<body  id="page-top">
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <?php $this->load->view("cs/__partials/navbar.php") ?>
        ...
        <!-- ============================================================== -->
            ...
            <?php $this->load->view("cs/__partials/sidebar.php") ?>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <a href="<?php echo site_url('cs/dashboard') ?>"><i data-feather="arrow-left" class="feather-icon"></i> Kembali</a>
                    </div>
                    <div class="card-body">
            ...
            <!-- ============================================================== -->
                ...
                <?php $this->load->view("cs/__partials/footer.php") ?>
